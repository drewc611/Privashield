...
Changes involving networking, authentication, authorization, secrets, DLP, AI authority, audit logging, dependencies, containers, or future enforcement require the Security Architect agent review or equivalent explicit security review notes.
