...
3. Phase 1 firewall behavior is observe/simulate only. Do not add packet dropping, nftables mutation, eBPF enforcement, quarantine, process termination, credential revocation, or destructive SOAR execution without a dedicated approved change.
