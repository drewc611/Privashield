...
`make verify` covers governance validation, formatting, linting, type checking,
the test suite against its coverage floor, the detection regression benchmark,
and the dashboard and Compose checks. Run `make help` for individual targets.
